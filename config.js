...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~e1xQwC4C#cq2hMqdQd2Pet-P_YRSY51XQO-UdV6N2dQCrgKaQ030",  // Your bot's session ID (keep it secure)
    ...
    CUSTOM_REACT_EMOJIS: getConfig("CUSTOM_REACT_EMOJIS") || process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,❤️‍🔥,💛,💚,💙,💜,🤎,🖤,🤍",  // set custom reacts
